<template>
  <div class="pagination">
    ...
    <button v-if="startAndEnd.start > 1" @click="$emit('currentPage',1)" :class="{active:pageNo==1}">1</button>
    ...
    <button v-if="startAndEnd.end < totalPage" @click="$emit('currentPage',totalPage)" :class="{active:pageNo==totalPage}">{{ totalPage }}</button>
